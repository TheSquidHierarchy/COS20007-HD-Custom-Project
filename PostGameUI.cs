...
{
    internal class PostGameUI : GameObject
    {
        private Bitmap _bitmap, _bitmap1;

        //Constructor
        private PostGameUI(float x, float y)
        {
            X = x;
            Y = y;
            _bitmap = new Bitmap("Restart", "C:\\Users\\matth\\OneDrive - Swinburne University\\2023 Swinburne\\OOP\\Custom Program\\Resources\\Restart.png");
        ...
        //Default Constructor
        public PostGameUI() : this(850, 450) { }
